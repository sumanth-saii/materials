...
class RMKEGURU(MDApp):
    ...
    def __init__(self,**kwargs):
    	super(RMKEGURU,self).__init__(**kwargs)
    	self.screen_list= []
    	Window.bind(on_keyboard=self.onbackbtn)
    
    def onbackbtn(self,window,key,*largs):
    	if key==27:
    	    self.root.current=self.screen_list.pop()
    	    return True
    	return False    	
    ...
    def mechsem1(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='mechsem1'
    
    def mechsem2(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='mechsem2'
    
    def mechsem3(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='mechsem3'
    
    def mechsem4(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='mechsem4'
   
    def mechsem5(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='mechsem5'
    
    def mechsem6(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='mechsem6'
    
    def mechsem7(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='mechsem7'
    	
    def mechsem8(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='mechsem8'		
    	
    def csesem1(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='csesem1'
    
    def csesem2(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='csesem2'
    
    def csesem3(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='csesem3'
    
    def csesem4(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='csesem4'
    
    def csesem5(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='csesem5'
    
    def csesem6(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='csesem6'
    
    def csesem7(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='csesem7'
    	
    def csesem8(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='csesem8'
    
    def itsem1(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='itsem1'
    
    def itsem2(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='itsem2'
    	
    def itsem3(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='itsem3'
    
    def itsem4(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='itsem4'
   
    def itsem5(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='itsem5'
    
    def itsem6(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='itsem6'
    
    def itsem7(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='itsem7'		 					
    def itsem8(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='itsem8'
    
    def ecesem1(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='ecesem1'
    
    def ecesem2(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='ecesem2'
    
    def ecesem3(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='ecesem3'
    
    def ecesem4(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='ecesem4'
    
    def ecesem5(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='ecesem5'
    
    def ecesem6(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='ecesem6'
    
    def ecesem7(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='ecesem7'
    
    def ecesem8(self):
    	self.screen_list.append(self.root.current)
    	self.root.current='ecesem8'
    ...
    def mPH8251all(self):
        webbrowser.open("https://drive.google.com/file/d/1CDsLq0n8nL55nv9FFct9MSnzWp5v-SJh/view?usp=sharing")

    def mBE8253u12(self):
        webbrowser.open("https://drive.google.com/file/d/1Jj69b3xxOYVXkuIi-BdTcuPCwu9nejEH/view?usp=sharing")

    def mBE8253u3(self):
        webbrowser.open("https://drive.google.com/file/d/1BQH3MXAaNeOpTmY6bcEp9TOSQjVqBUd9/view?usp=sharing")

    def mBE8253u4(self):
        webbrowser.open("https://drive.google.com/file/d/19mgbgZHopi7Xk6he3x0ZbJZ42yUyYHW3/view?usp=sharing")

    def mBE8253u5(self):
        webbrowser.open("https://drive.google.com/file/d/1RFfqolCcI8FiJrnoxLkiWr5M9Em9wMvW/view?usp=sharing")

    def mGE8292all(self):
        webbrowser.open("https://drive.google.com/file/d/1xGb-9Dr0jYNjl-p_rO-B9lHlrRW5oZlX/view?usp=sharing")    
    def map(self):
